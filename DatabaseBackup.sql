...
\restrict mlWtdf78eV1dn2lA732hJb2AL659PAg6IK8mcqvPlasVWjHexHeqRobhsxLfT0J
...
ALTER TABLE IF EXISTS ONLY public.incidencias DROP CONSTRAINT IF EXISTS fk_incidencia_equipamiento;
ALTER TABLE IF EXISTS ONLY public.incidencias DROP CONSTRAINT IF EXISTS fk_incidencia_alumno;
ALTER TABLE IF EXISTS ONLY public.incidencias DROP CONSTRAINT IF EXISTS fk_incidencia_administrador;
ALTER TABLE IF EXISTS ONLY public.incidencias DROP CONSTRAINT IF EXISTS incidencias_pkey;
ALTER TABLE IF EXISTS ONLY public.equipamientos DROP CONSTRAINT IF EXISTS equipamientos_pkey;
ALTER TABLE IF EXISTS ONLY public.alumnos DROP CONSTRAINT IF EXISTS alumnos_pkey;
ALTER TABLE IF EXISTS ONLY public.alumnos DROP CONSTRAINT IF EXISTS alumnos_numero_control_key;
ALTER TABLE IF EXISTS ONLY public.alumnos DROP CONSTRAINT IF EXISTS alumnos_correo_key;
ALTER TABLE IF EXISTS ONLY public.administradores DROP CONSTRAINT IF EXISTS administradores_usuario_key;
ALTER TABLE IF EXISTS ONLY public.administradores DROP CONSTRAINT IF EXISTS administradores_pkey;
ALTER TABLE IF EXISTS ONLY public.administradores DROP CONSTRAINT IF EXISTS administradores_correo_key;
DROP TABLE IF EXISTS public.incidencias;
DROP SEQUENCE IF EXISTS public.incidencias_id_incidencia_seq;
DROP TABLE IF EXISTS public.equipamientos;
...
COPY public.alumnos (id_alumno, numero_control, nombre, primer_apellido, segundo_apellido, semestre, grupo, correo, numero_asiento, telefono, rol, contrasena, activo, fecha_registro, usuario) FROM stdin;
1	7738548954	rosabel	lopez	sarabi	6	B	correonxsdk@institucion.edu.mx	7	8662494930	Estudiante	admin	t	2026-06-06 13:34:44.335936	admin
2	87283827	flor	lopez	bautista	4	H	dummynjdnjf@test.com	6	7829430430	Estudiante	admin	t	2026-06-06 13:39:36.75713	admin
3	763457467	rosa	cruz	vargas	4	J	dummhdhay@test.com	9	8628390445	Estudiante	admin	t	2026-06-06 13:39:36.75713	admin
4	3747847	rosendo	ros	quiro	6	J	correojnaan@institucion.edu.mx	3	7577889009	Estudiante	admin	t	2026-06-06 14:16:33.606208	admin
admin	999999999	Usuario	Generico	\N	N/A	N/A	dummy@test.com	\N	\N	Estudiante	admin	t	2026-06-06 19:05:49.185764	admin
5	773674734	fernando	lopez	lopez	4	A	dummyfer@test.com	7	7163723623	Estudiante	admin	t	2026-06-06 22:44:32.165556	admin
\.
...
7637635	Teclado	Hardware y software	\N	\N	\N	\N	\N	\N
\.
...
19	7637635	admin	\N	Teclado desconfigurado	la tecla no funciona correctamente	Activa	2026-06-06	19:05:00	\N	\N	\N	\N
\.
...
SELECT pg_catalog.setval('public.incidencias_id_incidencia_seq', 19, true);
...
\unrestrict mlWtdf78eV1dn2lA732hJb2AL659PAg6IK8mcqvPlasVWjHexHeqRobhsxLfT0J
